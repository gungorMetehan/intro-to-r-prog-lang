...
# sekiz elemanli karakter tipinde bir vektor olusturma
komsular <- c("Yunanistan", "Bulgaristan", "Gurcistan", "Ermenistan", "Azerbaycan", "Iran", "Irak", "Suriye")
length(komsular)
...
komsular
komsular[5] <- "Azerbaycan (Nahcivan uzerinden)"
komsular
...
komsular[9] <- "Rusya"
komsular
komsular[11] <- "Romanya" # sonuc ne olur?
komsular
...
assign("test-sonuclari", c(1.231, 1.273, 1.233, 1.233, 1.241, 1.247, 1.229, 1.238))
...
kritiklik <- factor(c("Dusuk", "Orta", "Yuksek", "Kritik", "Orta", "Yuksek"),
...
maas <- c(120000, 120000, 90000, 70000, 60000, 75000, 90000, 100000, 90000, 90000)
...
subset(iris, Sepal.Width < 2.8)
subset(iris, Sepal.Width < 3.5 & Petal.Length > 4.5)
